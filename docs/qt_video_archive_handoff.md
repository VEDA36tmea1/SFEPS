...
REC_STORAGE|USED_BYTES=2147483648|CAP_BYTES=5368709120|FILE_COUNT=3
```
...
REC_STORAGE|USED_BYTES=2214592512|CAP_BYTES=5368709120|FILE_COUNT=4
REC_DEL|3511
REC_STORAGE|USED_BYTES=2147483648|CAP_BYTES=5368709120|FILE_COUNT=3
```
...
- `CAP_BYTES`: `videos` 폴더에 허용된 최대 용량 바이트 (`SFEPS_VIDEO_MAX_STORAGE_BYTES`)
