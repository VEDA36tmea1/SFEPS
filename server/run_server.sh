...
: "${SFEPS_ESP_TCP_BIND_IP:=192.168.4.1}"
: "${SFEPS_ESP_TCP_PORT:=5565}"
: "${SFEPS_ESP_TCP_MAX_CLIENTS:=4}"
...
export SFEPS_ESP_TCP_ENABLE
export SFEPS_ESP_TCP_BIND_IP
export SFEPS_ESP_TCP_PORT
export SFEPS_ESP_TCP_MAX_CLIENTS
if [[ -n "${SFEPS_ESP_TCP_ALLOW_IPS:-}" ]]; then
  export SFEPS_ESP_TCP_ALLOW_IPS
fi
...
log_info "SFEPS_ESP_TCP_ENABLE=${SFEPS_ESP_TCP_ENABLE}"
log_info "SFEPS_ESP_TCP_BIND_IP=${SFEPS_ESP_TCP_BIND_IP}"
log_info "SFEPS_ESP_TCP_PORT=${SFEPS_ESP_TCP_PORT}"
log_info "SFEPS_ESP_TCP_MAX_CLIENTS=${SFEPS_ESP_TCP_MAX_CLIENTS}"
if [[ -n "${SFEPS_APP_TLS_CERT_FILE:-}" ]]; then
...
if [[ -n "${SFEPS_ESP_TCP_ALLOW_IPS:-}" ]]; then
  log_info "SFEPS_ESP_TCP_ALLOW_IPS=${SFEPS_ESP_TCP_ALLOW_IPS}"
fi
